...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        if((nameChecked && emailChecked && descriptworkChecked) === true){
            ...
            Axios.post('http://localhost:3001/api/contact-email',emailContactObject)
            .then((result) => {
                ...
                <div className="container px-3">
                    <div className="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div className="text-center mb-5">
                            <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i className="fas fa-envelope"></i></div>
