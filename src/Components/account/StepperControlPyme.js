...
const StepperControlPyme = ({ handleClick, currentStep, steps}) =>{

  let handleEvent = new CustomEvent('handleEventPyme',{ detail: false,bubbles: true, cancelable: true});
...
export default StepperControlPyme