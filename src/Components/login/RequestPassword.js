...
const RecoverPassword = () => {
    ...
    const setNewPassword = (e) =>{
        ...
        value1.match(/[a-z]/) && value1.match(/[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/) && ((value1 === value2) && (value1 !==""))){
            ...
            Axios.put("http://ec2-54-174-104-208.compute-1.amazonaws.com:3001/api/forgot-password", { password: value1, email: response.data })
            .then((result) => {
    ...
    useEffect(() => {
        Axios.get(`http://ec2-54-174-104-208.compute-1.amazonaws.com:3001/resetear-password/${id}/${token}`)
        .then((result) => {
            setTimeout(() =>{
                setLoading(false);
                setResponse(result)
