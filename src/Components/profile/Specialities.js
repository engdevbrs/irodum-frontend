    ...
    const deleteEspeciality = (e) =>{
        ...
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                Axios.delete("http://http://ec2-54-174-104-208.compute-1.amazonaws.com:3001/api/delete-especiality" + especialityToDelete,
                {
                    headers: {
                    'authorization': `${token}`
                    }
                ...
                especialityData.map(values =>{
                    return(
                        <>
                            ...
                            <td ><a href={"http://http://ec2-54-174-104-208.compute-1.amazonaws.com:3001/" + values.image.originalname} 
