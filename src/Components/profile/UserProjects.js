...
import loadingprofilegf from '../assets/loading-profile-projects.svg'
                                                ...
                                                return(
                                                    ...
                                                    <Col className='mb-2 col-xxl-4 col-xl-6 col-lg-6 col-md-12 col-sm-6 col-12'>
                                                        <Card className='cardproject rounded-3'>
                                                            ...
                                                            <Row>
                                                                <Col className='col-12 text-start col'>Celular: {value.clientCell}</Col>
                                                                <Col className='col-12 text-start col'>{value.clientEmail !== "" ? "Email: " + value.clientEmail : ""}</Col>
                                                            </Row>
                                                            </Card.Footer>
                                                        </Card>
                                                    </Col>
